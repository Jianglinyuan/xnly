...
const main = (function($) {
  ...
  /**
    ...
    initEvents() {
      ...
      _.$viewer
        ...
        .on('touchmove', function(event) {
          ...
          // Calculate stuff.
          let	diffX = _.$viewer.touchPosX - event.originalEvent.touches[0].pageX,
      ...
      _.$main
        ...
        .on('touchmove', function(event) {
          ...
          // Calculate stuff.
          let	diffX = _.$main.touchPosX - event.originalEvent.touches[0].pageX,
    ...
    switchTo(index, noHide) {
      ...
      // Get slides.
      let	oldSlide = (_.current !== null ? _.slides[_.current] : null),
